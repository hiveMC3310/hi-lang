...
impl std::hash::Hash for Value {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) {
        ...
        match self {
            ...
            Value::Nil => {}
            Value::Function(name) => hi_common::resolve(*name).hash(state),
...
impl fmt::Debug for Value {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Value::Function(name) => write!(f, "Function({})", hi_common::resolve(*name)),
...
impl fmt::Display for Value {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Value::Nil => write!(f, "nil"),
            Value::Function(name) => write!(f, "<func {}>", hi_common::resolve(*name)),
